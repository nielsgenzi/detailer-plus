...
const StrategySection = () => {
  ...
  const benefits = [
    ...
    "Only pay for closed jobs, not leads",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Our proven 3-step process has helped over 200+ auto detailing businesses 
            consistently add $75K+ in monthly revenue.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {steps.map((step, index) => {
            ...
            return (
              <Card key={index} className="relative bg-gradient-card border-border/50 group hover:shadow-elegant transition-all duration-300">
