          ...
          <div className="space-y-8">
            <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  {callDetails.map((detail, index) => <div key={index} className="flex items-start gap-3">
            ...
            <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  {qualifications.map((qualification, index) => <div key={index} className="flex items-start gap-3">
